...
6. Make sure That added Document or section is well mentioned in the `docs-order-configs.ts` (check [Documentation ordering system](/docs/Documentation-guide/customization/section-ordering))
