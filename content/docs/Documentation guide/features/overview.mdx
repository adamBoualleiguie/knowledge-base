...
- **Hero Image & Video** - Full-width hero banner at the top of docs and blog posts
...
- [Hero Image & Video](/docs/guide/features/hero-media) - Hero banner at top of doc or blog
