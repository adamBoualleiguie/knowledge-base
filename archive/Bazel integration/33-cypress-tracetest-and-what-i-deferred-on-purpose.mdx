---
title: "Cypress, Tracetest, integration prelude: what I deferred on purpose"
description: "Where E2E and trace-based tests sit relative to Bazel today, what stayed on Docker/Compose, and how deferrals stay explicit."
...
# Cypress, Tracetest, integration prelude: what I deferred on purpose
...
<Terminal
  ...
  commands={[
    {
      command: "make build && docker system prune -f && make run-tracetesting",
      output: "",
    },
  ]}
/>
